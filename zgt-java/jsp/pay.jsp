		...
		<table width="80%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<form method="post" action="sendPay.jsp" target="_blank" accept-charset="UTF-8">
				...
				<tr >
					...
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="callbackurl" value="http://localhost:8080/zgt-java/jsp/callback.jsp" />
						<span style="color:#FF0000;font-weight:100;">*</span>
					</td>
					<td width="5%"  align="center"> - </td> 
				...
				<tr >
					...
					<td width="5%"  align="center"> : &nbsp;</td> 
					<td width="55%" align="left"> 
						<input size="70" type="text" name="webcallbackurl" value="http://localhost:8080/zgt-api-demo/jsp/callback.jsp" />
					</td>
					<td width="5%"  align="center"> - </td> 
